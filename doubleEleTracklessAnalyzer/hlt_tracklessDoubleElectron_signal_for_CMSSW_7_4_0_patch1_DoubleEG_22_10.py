...
process.hasTrackedCandidate = cms.EDFilter("CandViewCountFilter",
		src = cms.InputTag("trackerCandidates"),
		minNumber = cms.uint32(1)
		)

process.hasTracklessCandidate = cms.EDFilter("CandViewCountFilter",
		src = cms.InputTag("noTrackerCandidates"),
		minNumber = cms.uint32(1)
		)


process.combRecoEleNoCutsHasTracklessAndTracked = cms.EDProducer("CandViewShallowCloneCombiner",
...
process.combRecoEleNoCutsRequireTrackless = cms.EDProducer("CandViewShallowCloneCombiner",
		decay = cms.string("noTrackerCandidates hltEgammaCandidates"),
		#checkCharge = cms.bool(False),
		cut = cms.string(""),
		#this name is tied to the CompositeCandidate object
		#name = cms.string('zedToElEl'),
...
process.combRecoEleNoCutsRequireTracked = cms.EDProducer("CandViewShallowCloneCombiner",
		decay = cms.string("hltEgammaCandidatesUnseeded trackerCandidates"),
		#checkCharge = cms.bool(False),
		cut = cms.string(""),
		#this name is tied to the CompositeCandidate object
		#name = cms.string('zedToElEl'),
...
process.recoZeeFilterNoCutsHasTracklessAndTracked = cms.EDFilter("CandViewCountFilter",
		src = cms.InputTag("combRecoEleNoCutsHasTracklessAndTracked"),
		minNumber = cms.uint32(1)
		)
...
process.recoDaughterProducerNoCutsRequireTrackless = cms.EDProducer("SeparateCombCandidate",
		zedLabel = cms.InputTag("combRecoEleNoCutsRequireTrackless"),
		tracklessHltEle = cms.InputTag("hltEgammaCandidatesUnseeded"),
		trackedHltEle = cms.InputTag("hltEgammaCandidates"),
		tracklessEleCollectionName = cms.string("tracklessDaughters"),
		trackedEleCollectionName = cms.string("trackedDaughters")
...
process.recoDaughterProducerNoCutsRequireTracked = cms.EDProducer("SeparateCombCandidate",
		zedLabel = cms.InputTag("combRecoEleNoCutsRequireTracked"),
		tracklessHltEle = cms.InputTag("hltEgammaCandidatesUnseeded"),
		trackedHltEle = cms.InputTag("hltEgammaCandidates"),
		tracklessEleCollectionName = cms.string("tracklessDaughters"),
		trackedEleCollectionName = cms.string("trackedDaughters")
...
process.recoDaughterProducerNoCutsHasTracklessAndTracked = cms.EDProducer("SeparateCombCandidate",
		zedLabel = cms.InputTag("combRecoEleNoCutsHasTracklessAndTracked"),
		tracklessHltEle = cms.InputTag("hltEgammaCandidatesUnseeded"),
		trackedHltEle = cms.InputTag("hltEgammaCandidates"),
		tracklessEleCollectionName = cms.string("tracklessDaughters"),
		trackedEleCollectionName = cms.string("trackedDaughters")
...
process.recoAnalyzerTrackedNoCutsHasTracklessAndTracked = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShape","sigmaIEtaIEta5x5","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverE","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIso","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIso","","TEST"),
		...
		Dphi=cms.InputTag("hltEgammaGsfTrackVars","Dphi","TEST"),
		TrackIso=cms.InputTag("hltEgammaEleGsfTrackIso","","TEST"),
		treeName = cms.string("recoTreeBeforeTriggerFiltersTrackedSignalNoCutsHasTracklessAndTracked"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsHasTracklessAndTracked","trackedDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(True),
		genCollection = cms.InputTag("","",""),
		dRMatch = cms.double(-1),
		recoZedCollection = cms.InputTag("combRecoEleNoCutsHasTracklessAndTracked","","TEST"),
		genZedCollection = cms.InputTag("","","")
...
process.recoAnalyzerTrackedNoCutsRequireTracked = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShape","sigmaIEtaIEta5x5","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverE","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIso","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIso","","TEST"),
		...
		Dphi=cms.InputTag("hltEgammaGsfTrackVars","Dphi","TEST"),
		TrackIso=cms.InputTag("hltEgammaEleGsfTrackIso","","TEST"),
		treeName = cms.string("recoTreeBeforeTriggerFiltersTrackedSignalNoCutsRequireTracked"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsRequireTracked","trackedDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(True),
		genCollection = cms.InputTag("","",""),
		dRMatch = cms.double(-1),
		recoZedCollection = cms.InputTag("combRecoEleNoCutsRequireTracked","","TEST"),
		genZedCollection = cms.InputTag("","","")
	
		)


process.recoAnalyzerTrackedNoCutsRequireTrackless = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShape","sigmaIEtaIEta5x5","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverE","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIso","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIso","","TEST"),
		...
		Dphi=cms.InputTag("hltEgammaGsfTrackVars","Dphi","TEST"),
		TrackIso=cms.InputTag("hltEgammaEleGsfTrackIso","","TEST"),
		treeName = cms.string("recoTreeBeforeTriggerFiltersTrackedSignalNoCutsRequireTrackless"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsRequireTrackless","trackedDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(True),
		genCollection = cms.InputTag("","",""),
		dRMatch = cms.double(-1),
		recoZedCollection = cms.InputTag("combRecoEleNoCutsRequireTrackless","","TEST"),
		genZedCollection = cms.InputTag("","","")
...
process.recoAnalyzerTracklessNoCutsHasTracklessAndTracked = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShapeUnseeded","","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverEUnseeded","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIsoUnseeded","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIsoUnseeded","","TEST"),
		...
		Dphi=cms.InputTag("","",""),
		TrackIso=cms.InputTag("","",""),
		treeName = cms.string("recoTreeBeforeTriggerFiltersTracklessSignalNoCutsHasTracklessAndTracked"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsHasTracklessAndTracked","tracklessDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(False),
		genCollection = cms.InputTag("","",""),
		dRMatch = cms.double(-1),
		recoZedCollection = cms.InputTag("combRecoEleNoCutsHasTracklessAndTracked","","TEST"),
...
process.recoAnalyzerTracklessNoCutsRequireTracked = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShapeUnseeded","","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverEUnseeded","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIsoUnseeded","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIsoUnseeded","","TEST"),
		...
		Dphi=cms.InputTag("","",""),
		TrackIso=cms.InputTag("","",""),
		treeName = cms.string("recoTreeBeforeTriggerFiltersTracklessSignalNoCutsRequireTracked"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsRequireTracked","tracklessDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(False),
		genCollection = cms.InputTag("","",""),
		dRMatch = cms.double(-1),
		recoZedCollection = cms.InputTag("combRecoEleNoCutsRequireTracked","","TEST"),
...
process.recoAnalyzerTracklessNoCutsRequireTrackless = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShapeUnseeded","","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverEUnseeded","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIsoUnseeded","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIsoUnseeded","","TEST"),
		...
		Dphi=cms.InputTag("","",""),
		TrackIso=cms.InputTag("","",""),
		treeName = cms.string("recoTreeBeforeTriggerFiltersTracklessSignalNoCutsRequireTrackless"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsRequireTrackless","tracklessDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(False),
		genCollection = cms.InputTag("","",""),
		dRMatch = cms.double(-1),
		recoZedCollection = cms.InputTag("combRecoEleNoCutsRequireTrackless","","TEST"),
...
process.recoAnalyzerMatchedTrackedNoCutsHasTracklessAndTracked = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShape","sigmaIEtaIEta5x5","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverE","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIso","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIso","","TEST"),
		...
		Dphi=cms.InputTag("hltEgammaGsfTrackVars","Dphi","TEST"),
		TrackIso=cms.InputTag("hltEgammaEleGsfTrackIso","","TEST"),
		treeName = cms.string("recoTreeBeforeTriggerFiltersMatchedTrackedSignalNoCutsHasTracklessAndTracked"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsHasTracklessAndTracked","trackedDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(True),
		genCollection = cms.InputTag("genEleTrack","","TEST"),
		dRMatch = cms.double(0.1),
...
process.recoAnalyzerMatchedTrackedNoCutsRequireTracked = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShape","sigmaIEtaIEta5x5","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverE","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIso","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIso","","TEST"),
		...
		Dphi=cms.InputTag("hltEgammaGsfTrackVars","Dphi","TEST"),
		TrackIso=cms.InputTag("hltEgammaEleGsfTrackIso","","TEST"),
		treeName = cms.string("recoTreeBeforeTriggerFiltersMatchedTrackedSignalNoCutsRequireTracked"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsRequireTracked","trackedDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(True),
		genCollection = cms.InputTag("genEleTrack","","TEST"),
		dRMatch = cms.double(0.1),
...
process.recoAnalyzerMatchedTrackedNoCutsRequireTrackless = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShape","sigmaIEtaIEta5x5","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverE","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIso","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIso","","TEST"),
		...
		Dphi=cms.InputTag("hltEgammaGsfTrackVars","Dphi","TEST"),
		TrackIso=cms.InputTag("hltEgammaEleGsfTrackIso","","TEST"),
		treeName = cms.string("recoTreeBeforeTriggerFiltersMatchedTrackedSignalNoCutsRequireTrackless"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsRequireTrackless","trackedDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(True),
		genCollection = cms.InputTag("genEleTrack","","TEST"),
		dRMatch = cms.double(0.1),
...
process.recoAnalyzerMatchedTracklessNoCutsHasTracklessAndTracked = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShapeUnseeded","","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverEUnseeded","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIsoUnseeded","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIsoUnseeded","","TEST"),
		...
		Dphi=cms.InputTag("","",""),
		TrackIso=cms.InputTag("","",""),
		treeName = cms.string("recoTreeBeforeTriggerFiltersMatchedTracklessSignalNoCutsHasTracklessAndTracked"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsHasTracklessAndTracked","tracklessDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(False),
		genCollection = cms.InputTag("genUntrack","","TEST"),
		dRMatch = cms.double(0.1),
...
process.recoAnalyzerMatchedTracklessNoCutsRequireTracked = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShapeUnseeded","","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverEUnseeded","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIsoUnseeded","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIsoUnseeded","","TEST"),
		...
		Dphi=cms.InputTag("","",""),
		TrackIso=cms.InputTag("","",""),
		treeName = cms.string("recoTreeBeforeTriggerFiltersMatchedTracklessSignalNoCutsRequireTracked"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsRequireTracked","tracklessDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(False),
		genCollection = cms.InputTag("genUntrack","","TEST"),
		dRMatch = cms.double(0.1),
...
process.recoAnalyzerMatchedTracklessNoCutsRequireTrackless = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShapeUnseeded","","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverEUnseeded","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIsoUnseeded","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIsoUnseeded","","TEST"),
		...
		Dphi=cms.InputTag("","",""),
		TrackIso=cms.InputTag("","",""),
		treeName = cms.string("recoTreeBeforeTriggerFiltersMatchedTracklessSignalNoCutsRequireTrackless"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerNoCutsRequireTrackless","tracklessDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(False),
		genCollection = cms.InputTag("genUntrack","","TEST"),
		dRMatch = cms.double(0.1),
...
process.recoAnalyzerTrackedStageTwo = cms.EDAnalyzer('recoAnalyzerGeneric',
		...
		Dphi=cms.InputTag("hltEgammaGsfTrackVars","Dphi","TEST"),
		TrackIso=cms.InputTag("hltEgammaEleGsfTrackIso","","TEST"),
		treeName = cms.string("recoTreeBeforeTriggerFiltersTrackedSignalStageTwo"),
...
process.recoAnalyzerTracklessStageTwo = cms.EDAnalyzer('recoAnalyzerGeneric',
		...
		Dphi=cms.InputTag("","",""),
		TrackIso=cms.InputTag("","",""),
		treeName = cms.string("recoTreeBeforeTriggerFiltersTracklessSignalStageTwo"),
...
process.recoAnalyzerMatchedTracklessStageTwo = cms.EDAnalyzer('recoAnalyzerGeneric',
		SigmaIEIE = cms.InputTag("hltEgammaClusterShapeUnseeded","","TEST"),
		HadEm=cms.InputTag("hltEgammaHoverEUnseeded","","TEST"),
		EcalIso=cms.InputTag("hltEgammaEcalPFClusterIsoUnseeded","","TEST"),
		HcalIso=cms.InputTag("hltEgammaHcalPFClusterIsoUnseeded","","TEST"),
		...
		Dphi=cms.InputTag("","",""),
		TrackIso=cms.InputTag("","",""),
		treeName = cms.string("recoTreeBeforeTriggerFiltersMatchedTracklessSignalStageTwo"),
		recoElectronCollection = cms.InputTag("recoDaughterProducerStageTwo","tracklessDaughters","TEST"),
		doAnalysisOfTracked = cms.bool(False),
		genCollection = cms.InputTag("genUntrack","","TEST"),
		dRMatch = cms.double(0.1),
...
process.HLT_Ele27_WPXX_Ele15_WPYY_trackless_Study_NoCutsHasTracklessAndTracked = cms.Path( 
		process.HLTBeginSequence 
		#+ process.hltL1sL1SingleEG20ORL1SingleEG22 
		+ process.hltPreEle27WPXXEle15WPYYtrackless 
		+ process.HLTEle27WPXXSequenceStudy 
		...
		+ process.noTrackerCandidates
		+ process.trackerCandidates
		+ process.combRecoEleNoCutsHasTracklessAndTracked
		*process.recoZeeFilterNoCutsHasTracklessAndTracked
		*process.recoDaughterProducerNoCutsHasTracklessAndTracked
		*process.recoAnalyzerTrackedNoCutsHasTracklessAndTracked
		*process.recoAnalyzerTracklessNoCutsHasTracklessAndTracked
		*process.ZeeFilter
		*process.recoAnalyzerMatchedTrackedNoCutsHasTracklessAndTracked
		*process.recoAnalyzerMatchedTracklessNoCutsHasTracklessAndTracked
		)
...
process.HLT_Ele27_WPXX_Ele15_WPYY_trackless_Study_NoCutsRequireTrackless = cms.Path( 
		process.HLTBeginSequence 
		#+ process.hltL1sL1SingleEG20ORL1SingleEG22 
		+ process.hltPreEle27WPXXEle15WPYYtrackless 
		+ process.HLTEle27WPXXSequenceStudy 
		...
		+ process.HLTEndSequence
		+ process.noTrackerCandidates
		+ process.hasTracklessCandidate
		#+ process.trackerCandidates
		+ process.combRecoEleNoCutsRequireTrackless
		#*process.recoZeeFilterNoCutsRequireTrackless
		*process.recoDaughterProducerNoCutsRequireTrackless
		*process.recoAnalyzerTrackedNoCutsRequireTrackless
		*process.recoAnalyzerTracklessNoCutsRequireTrackless
		*process.ZeeFilter
		*process.recoAnalyzerMatchedTrackedNoCutsRequireTrackless
		*process.recoAnalyzerMatchedTracklessNoCutsRequireTrackless
		)

process.HLT_Ele27_WPXX_Ele15_WPYY_trackless_Study_NoCutsRequireTracked = cms.Path( 
		process.HLTBeginSequence 
		#+ process.hltL1sL1SingleEG20ORL1SingleEG22 
		+ process.hltPreEle27WPXXEle15WPYYtrackless 
		+ process.HLTEle27WPXXSequenceStudy 
		...
		#+ process.noTrackerCandidates
		+ process.trackerCandidates
		+ process.hasTrackedCandidate
		+ process.combRecoEleNoCutsRequireTracked
		#*process.recoZeeFilterNoCutsRequireTracked
		*process.recoDaughterProducerNoCutsRequireTracked
		*process.recoAnalyzerTrackedNoCutsRequireTracked
		*process.recoAnalyzerTracklessNoCutsRequireTracked
		*process.ZeeFilter
		*process.recoAnalyzerMatchedTrackedNoCutsRequireTracked
		*process.recoAnalyzerMatchedTracklessNoCutsRequireTracked
		)
...
process.TFileService = cms.Service("TFileService",
		fileName = cms.string('signal_analyzer_trees_NUM_inspect_reco_eff_CMSSW_7_4_0_patch1_25ns_DoubleEG_22_10.root')
