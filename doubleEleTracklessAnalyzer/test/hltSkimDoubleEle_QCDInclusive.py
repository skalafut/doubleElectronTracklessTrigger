...
process.hltOutputPhysicsEGamma = cms.OutputModule( "PoolOutputModule",
    fileName = cms.untracked.string( "QCDInclusive_skim.root" ),
    fastCloning = cms.untracked.bool( False ),
    dataset = cms.untracked.PSet(
        filterName = cms.untracked.string( "" ),
...
process.load('doubleElectronTracklessTrigger.doubleEleTracklessAnalyzer.genPartonModules_cff')

process.genPtFilter = cms.EDFilter('htFilter',
		cutThreshold = cms.double(170.),
		inputCollection = cms.InputTag("mergeGenPartons")
		)

#add PT filter to FirstPath to skip evts with SUM GEN pt below 170 GeV
process.HLTriggerFirstPath = cms.Path( 
		process.genPartonsSeq
		*process.mergeGenPartonsSeq
		*process.genPtFilter
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Ele27_HighEta_Ele20_Mass55_v8, process.HLTriggerFinalPath, process.PhysicsEGammaOutput ))
