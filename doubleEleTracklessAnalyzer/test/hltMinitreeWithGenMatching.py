...
process.recoAnalyzerMatchedTrackedWithL1Filter = cms.EDAnalyzer('recoAnalyzerGeneric',
		...
		recoElectronCollection = cms.InputTag("recoDaughterProducer","trackedDaughters","MINITREE"),
		doAnalysisOfTracked = cms.bool(True),
		genCollection = cms.InputTag("genEleTrack","","MINITREE"),
		dRMatch = cms.double(0.15),
		recoZedCollection = cms.InputTag("combRecoEle","","MINITREE"),
		genZedCollection = cms.InputTag("combEle","","MINITREE")
...
process.recoAnalyzerMatchedTracklessWithL1Filter = cms.EDAnalyzer('recoAnalyzerGeneric',
		...
		recoElectronCollection = cms.InputTag("recoDaughterProducer","tracklessDaughters","MINITREE"),
		doAnalysisOfTracked = cms.bool(False),
		genCollection = cms.InputTag("genUntrack","","MINITREE"),
		dRMatch = cms.double(0.15),
		recoZedCollection = cms.InputTag("combRecoEle","","MINITREE"),
		genZedCollection = cms.InputTag("combEle","","MINITREE")
...
process.HLT_Ele27_HighEta_Ele20_Mass55_StudyWithL1Filter = cms.Path(
		...
		*process.recoAnalyzerTrackedWithL1Filter  #need this for the rate estimate
		*process.recoAnalyzerTracklessWithL1Filter  #need this for the rate estimate
		*process.ZeeFilter
		*process.recoAnalyzerMatchedTrackedWithL1Filter  #need this for the signal efficiency estimate
		*process.recoAnalyzerMatchedTracklessWithL1Filter #need this for the signal efficiency estimate
		)
...
_customInfo['inputFile'] = 'file:DYJets_madgraph_skim.root'
