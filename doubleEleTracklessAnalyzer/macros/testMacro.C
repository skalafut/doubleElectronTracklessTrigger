...
void compareMatchedSigAndBkgnd(TChain * sigChain,TChain * bkgndVeryHighPtChain,TChain * bkgndHighPtChain,TChain * bkgndLowPtChain,TString sigFillArgs,TString sigListName,TString bkgndVHPtFillArgs,TString bkgndVHPtListName,TString bkgndHPtFillArgs,TString bkgndHPtListName,TString bkgndLPtFillArgs,TString bkgndLPtListName,TString sigHistPlotArg,TString bkgndVHPtHistPlotArg,TString bkgndHPtHistPlotArg,TString bkgndLPtHistPlotArg,TString sigHistName,TString bkgndVHPtHistName,TString bkgndHPtHistName,TString bkgndLPtHistName,Double_t highEffCutVal,Double_t lowEffCutVal,Double_t optimalCutVal,TString histTitle,TString xAxisTitle,TString canvName,TString outputFile,Bool_t isPlottingEnergy,Bool_t isPlottingInverseEnergy,Bool_t isLowerBound,Bool_t doCrossSxnNormalization,TString etaRegion){
	if(!(etaRegion.Contains("tracklessEE")) && !(etaRegion.Contains("trackedEE")) && !(etaRegion.Contains("EB")) ){
		std::cout<<"etaRegion is not formatted correctly!  Leaving fxn."<<std::endl;
		return;
	}
	TCut filters="";
	if(etaRegion.Contains("tracklessEE")){
	...
	if(sigHist->GetBinContent(sigHist->GetMaximumBin()) < bkgndHighPtHist->GetBinContent(bkgndHighPtHist->GetMaximumBin())){
		...
		highEffLine = new TLine(highEffCutVal,sigHist->GetBinContent(sigHist->GetMinimumBin()), highEffCutVal+shift, (1.0)*bkgndHighPtHist->GetBinContent(bkgndHighPtHist->GetMaximumBin()));
		lowEffLine = new TLine(lowEffCutVal,sigHist->GetBinContent(sigHist->GetMinimumBin()), lowEffCutVal+shift, (1.0)*bkgndHighPtHist->GetBinContent(bkgndHighPtHist->GetMaximumBin()));
		optimalCutLine = new TLine(optimalCutVal,sigHist->GetBinContent(sigHist->GetMinimumBin()), optimalCutVal+shift, (1.0)*bkgndHighPtHist->GetBinContent(bkgndHighPtHist->GetMaximumBin()));
		...
		highEffLine = new TLine(highEffCutVal,sigHist->GetBinContent(sigHist->GetMinimumBin()), highEffCutVal+shift, (1.0)*sigHist->GetBinContent(sigHist->GetMaximumBin()));
		lowEffLine = new TLine(lowEffCutVal,sigHist->GetBinContent(sigHist->GetMinimumBin()), lowEffCutVal+shift, (1.0)*sigHist->GetBinContent(sigHist->GetMaximumBin()));
		optimalCutLine = new TLine(optimalCutVal,sigHist->GetBinContent(sigHist->GetMinimumBin()), optimalCutVal+shift, (1.0)*sigHist->GetBinContent(sigHist->GetMaximumBin()));
	}
	...
	sigHist->SetFillColor(21);
	bkgndHighPtHist->SetFillColor(30);
...
void testMacro(){
	...
	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>dEtaTrackedBarrelSignalList","dEtaTrackedBarrelSignalList",">>dEtaTrackedBarrelVHPtBkgndList","dEtaTrackedBarrelVHPtBkgndList",">>dEtaTrackedBarrelHPtBkgndList","dEtaTrackedBarrelHPtBkgndList",">>dEtaTrackedBarrelLPtBkgndList","dEtaTrackedBarrelLPtBkgndList","dEtaHltEle>>dEtaTrackedBarrelSignalHisto(100,0.,0.03)","dEtaHltEle>>dEtaTrackedBarrelVHPtBkgndHisto(100,0.,0.03)","dEtaHltEle>>dEtaTrackedBarrelHPtBkgndHisto(100,0.,0.03)","dEtaHltEle>>dEtaTrackedBarrelLPtBkgndHisto(100,0.,0.03)","dEtaTrackedBarrelSignalHisto","dEtaTrackedBarrelVHPtBkgndHisto","dEtaTrackedBarrelHPtBkgndHisto","dEtaTrackedBarrelLPtBkgndHisto",0.03,0.015,0.021,"#Delta #eta in EB for signal and bkgnds","#Delta #eta","c15","dEta_EB_matched_signal_and_bkgnds_showing_scan_range.png",false,false,false,false,"EB");
	//	
	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>dPhiTrackedBarrelSignalList","dPhiTrackedBarrelSignalList",">>dPhiTrackedBarrelVHPtBkgndList","dPhiTrackedBarrelVHPtBkgndList",">>dPhiTrackedBarrelHPtBkgndList","dPhiTrackedBarrelHPtBkgndList",">>dPhiTrackedBarrelLPtBkgndList","dPhiTrackedBarrelLPtBkgndList","dPhiHltEle>>dPhiTrackedBarrelSignalHisto(100,0.,0.4)","dPhiHltEle>>dPhiTrackedBarrelVHPtBkgndHisto(100,0.,0.4)","dPhiHltEle>>dPhiTrackedBarrelHPtBkgndHisto(100,0.,0.4)","dPhiHltEle>>dPhiTrackedBarrelLPtBkgndHisto(100,0.,0.4)","dPhiTrackedBarrelSignalHisto","dPhiTrackedBarrelVHPtBkgndHisto","dPhiTrackedBarrelHPtBkgndHisto","dPhiTrackedBarrelLPtBkgndHisto",0.35,0.15,0.26,"#Delta #phi in EB for signal and bkgnds","#Delta #phi","c16","dPhi_EB_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"EB");


	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>epTrackedBarrelSignalList","epTrackedBarrelSignalList",">>epTrackedBarrelVHPtBkgndList","epTrackedBarrelVHPtBkgndList",">>epTrackedBarrelHPtBkgndList","epTrackedBarrelHPtBkgndList",">>epTrackedBarrelLPtBkgndList","epTrackedBarrelLPtBkgndList","epHltEle>>epTrackedBarrelSignalHisto(100,0.,0.25)","epHltEle>>epTrackedBarrelVHPtBkgndHisto(100,0.,0.25)","epHltEle>>epTrackedBarrelHPtBkgndHisto(100,0.,0.25)","epHltEle>>epTrackedBarrelLPtBkgndHisto(100,0.,0.25)","epTrackedBarrelSignalHisto","epTrackedBarrelVHPtBkgndHisto","epTrackedBarrelHPtBkgndHisto","epTrackedBarrelLPtBkgndHisto",0.24,0.13,0.16,"E/P in EB for signal and bkgnds","E/P","c17","ep_EB_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"EB");

	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>trackIsoTrackedBarrelSignalList","trackIsoTrackedBarrelSignalList",">>trackIsoTrackedBarrelVHPtBkgndList","trackIsoTrackedBarrelVHPtBkgndList",">>trackIsoTrackedBarrelHPtBkgndList","trackIsoTrackedBarrelHPtBkgndList",">>trackIsoTrackedBarrelLPtBkgndList","trackIsoTrackedBarrelLPtBkgndList","trackIsoHltEle>>trackIsoTrackedBarrelSignalHisto(100,0.,0.25)","trackIsoHltEle>>trackIsoTrackedBarrelVHPtBkgndHisto(100,0.,0.25)","trackIsoHltEle>>trackIsoTrackedBarrelHPtBkgndHisto(100,0.,0.25)","trackIsoHltEle>>trackIsoTrackedBarrelLPtBkgndHisto(100,0.,0.25)","trackIsoTrackedBarrelSignalHisto","trackIsoTrackedBarrelVHPtBkgndHisto","trackIsoTrackedBarrelHPtBkgndHisto","trackIsoTrackedBarrelLPtBkgndHisto",0.2,0.1,0.125,"relative trackIso in EB for signal and bkgnds","relative trackIso","c21","rel_trackIso_EB_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"EB");
	
	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>ptTrackedBarrelSignalList","ptTrackedBarrelSignalList",">>ptTrackedBarrelVHPtBkgndList","ptTrackedBarrelVHPtBkgndList",">>ptTrackedBarrelHPtBkgndList","ptTrackedBarrelHPtBkgndList",">>ptTrackedBarrelLPtBkgndList","ptTrackedBarrelLPtBkgndList","ptHltEle>>ptTrackedBarrelSignalHisto(100,0.,35.)","ptHltEle>>ptTrackedBarrelVHPtBkgndHisto(100,0.,35.)","ptHltEle>>ptTrackedBarrelHPtBkgndHisto(100,0.,35.)","ptHltEle>>ptTrackedBarrelLPtBkgndHisto(100,0.,35.)","ptTrackedBarrelSignalHisto","ptTrackedBarrelVHPtBkgndHisto","ptTrackedBarrelHPtBkgndHisto","ptTrackedBarrelLPtBkgndHisto",27,27,27,"pt in EB for signal and bkgnds","pt","c23","pt_EB_matched_signal_and_bkgnds_showing_scan_range.png",true,false,true,false,"EB");
	



	///trackedEE
	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>clusterShapeTrackedEndcapSignalList","clusterShapeTrackedEndcapSignalList",">>clusterShapeTrackedEndcapVHPtBkgndList","clusterShapeTrackedEndcapVHPtBkgndList",">>clusterShapeTrackedEndcapHPtBkgndList","clusterShapeTrackedEndcapHPtBkgndList",">>clusterShapeTrackedEndcapLPtBkgndList","clusterShapeTrackedEndcapLPtBkgndList","clusterShapeHltEle>>clusterShapeTrackedEndcapSignalHisto(100,0.,0.055)","clusterShapeHltEle>>clusterShapeTrackedEndcapVHPtBkgndHisto(100,0.,0.055)","clusterShapeHltEle>>clusterShapeTrackedEndcapHPtBkgndHisto(100,0.,0.055)","clusterShapeHltEle>>clusterShapeTrackedEndcapLPtBkgndHisto(100,0.,0.055)","clusterShapeTrackedEndcapSignalHisto","clusterShapeTrackedEndcapVHPtBkgndHisto","clusterShapeTrackedEndcapHPtBkgndHisto","clusterShapeTrackedEndcapLPtBkgndHisto",0.036,0.028,0.032,"#sigma_{i#etai#eta} in trackedEE for signal and bkgnds","#sigma_{i#etai#eta}","c5","cluster_shape_trackedEE_matched_signal_and_bkgnds_showing_scan_range.png",false,false,false,false,"trackedEE");

	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>hadEmTrackedEndcapSignalList","hadEmTrackedEndcapSignalList",">>hadEmTrackedEndcapVHPtBkgndList","hadEmTrackedEndcapVHPtBkgndList",">>hadEmTrackedEndcapHPtBkgndList","hadEmTrackedEndcapHPtBkgndList",">>hadEmTrackedEndcapLPtBkgndList","hadEmTrackedEndcapLPtBkgndList","hadEmHltEle>>hadEmTrackedEndcapSignalHisto(100,0.,0.4)","hadEmHltEle>>hadEmTrackedEndcapVHPtBkgndHisto(100,0.,0.4)","hadEmHltEle>>hadEmTrackedEndcapHPtBkgndHisto(100,0.,0.4)","hadEmHltEle>>hadEmTrackedEndcapLPtBkgndHisto(100,0.,0.4)","hadEmTrackedEndcapSignalHisto","hadEmTrackedEndcapVHPtBkgndHisto","hadEmTrackedEndcapHPtBkgndHisto","hadEmTrackedEndcapLPtBkgndHisto",0.2,0.1,0.15,"relative H/E in trackedEE for signal and bkgnds","relative H/E","c6","rel_HoverE_trackedEE_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"trackedEE");

	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>ecalIsoTrackedEndcapSignalList","ecalIsoTrackedEndcapSignalList",">>ecalIsoTrackedEndcapVHPtBkgndList","ecalIsoTrackedEndcapVHPtBkgndList",">>ecalIsoTrackedEndcapHPtBkgndList","ecalIsoTrackedEndcapHPtBkgndList",">>ecalIsoTrackedEndcapLPtBkgndList","ecalIsoTrackedEndcapLPtBkgndList","ecalIsoHltEle>>ecalIsoTrackedEndcapSignalHisto(100,0.,0.5)","ecalIsoHltEle>>ecalIsoTrackedEndcapVHPtBkgndHisto(100,0.,0.5)","ecalIsoHltEle>>ecalIsoTrackedEndcapHPtBkgndHisto(100,0.,0.5)","ecalIsoHltEle>>ecalIsoTrackedEndcapLPtBkgndHisto(100,0.,0.5)","ecalIsoTrackedEndcapSignalHisto","ecalIsoTrackedEndcapVHPtBkgndHisto","ecalIsoTrackedEndcapHPtBkgndHisto","ecalIsoTrackedEndcapLPtBkgndHisto",0.26,0.12,0.2,"relative ecalIso in trackedEE for signal and bkgnds","relative ecalIso","c7","rel_ecalIso_trackedEE_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"trackedEE");

	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>hcalIsoTrackedEndcapSignalList","hcalIsoTrackedEndcapSignalList",">>hcalIsoTrackedEndcapVHPtBkgndList","hcalIsoTrackedEndcapVHPtBkgndList",">>hcalIsoTrackedEndcapHPtBkgndList","hcalIsoTrackedEndcapHPtBkgndList",">>hcalIsoTrackedEndcapLPtBkgndList","hcalIsoTrackedEndcapLPtBkgndList","hcalIsoHltEle>>hcalIsoTrackedEndcapSignalHisto(100,0.,0.6)","hcalIsoHltEle>>hcalIsoTrackedEndcapVHPtBkgndHisto(100,0.,0.6)","hcalIsoHltEle>>hcalIsoTrackedEndcapHPtBkgndHisto(100,0.,0.6)","hcalIsoHltEle>>hcalIsoTrackedEndcapLPtBkgndHisto(100,0.,0.6)","hcalIsoTrackedEndcapSignalHisto","hcalIsoTrackedEndcapVHPtBkgndHisto","hcalIsoTrackedEndcapHPtBkgndHisto","hcalIsoTrackedEndcapLPtBkgndHisto",0.34,0.2,0.27,"relative hcalIso in trackedEE for signal and bkgnds","relative hcalIso","c8","rel_hcalIso_trackedEE_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"trackedEE");
	
	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>dEtaTrackedEndcapSignalList","dEtaTrackedEndcapSignalList",">>dEtaTrackedEndcapVHPtBkgndList","dEtaTrackedEndcapVHPtBkgndList",">>dEtaTrackedEndcapHPtBkgndList","dEtaTrackedEndcapHPtBkgndList",">>dEtaTrackedEndcapLPtBkgndList","dEtaTrackedEndcapLPtBkgndList","dEtaHltEle>>dEtaTrackedEndcapSignalHisto(100,0.,0.03)","dEtaHltEle>>dEtaTrackedEndcapVHPtBkgndHisto(100,0.,0.03)","dEtaHltEle>>dEtaTrackedEndcapHPtBkgndHisto(100,0.,0.03)","dEtaHltEle>>dEtaTrackedEndcapLPtBkgndHisto(100,0.,0.03)","dEtaTrackedEndcapSignalHisto","dEtaTrackedEndcapVHPtBkgndHisto","dEtaTrackedEndcapHPtBkgndHisto","dEtaTrackedEndcapLPtBkgndHisto",0.03,0.015,0.021,"#Delta #eta in trackedEE for signal and bkgnds","#Delta #eta","c18","dEta_trackedEE_matched_signal_and_bkgnds_showing_scan_range.png",false,false,false,false,"trackedEE");
	//	
	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>dPhiTrackedEndcapSignalList","dPhiTrackedEndcapSignalList",">>dPhiTrackedEndcapVHPtBkgndList","dPhiTrackedEndcapVHPtBkgndList",">>dPhiTrackedEndcapHPtBkgndList","dPhiTrackedEndcapHPtBkgndList",">>dPhiTrackedEndcapLPtBkgndList","dPhiTrackedEndcapLPtBkgndList","dPhiHltEle>>dPhiTrackedEndcapSignalHisto(100,0.,0.4)","dPhiHltEle>>dPhiTrackedEndcapVHPtBkgndHisto(100,0.,0.4)","dPhiHltEle>>dPhiTrackedEndcapHPtBkgndHisto(100,0.,0.4)","dPhiHltEle>>dPhiTrackedEndcapLPtBkgndHisto(100,0.,0.4)","dPhiTrackedEndcapSignalHisto","dPhiTrackedEndcapVHPtBkgndHisto","dPhiTrackedEndcapHPtBkgndHisto","dPhiTrackedEndcapLPtBkgndHisto",0.35,0.15,0.26,"#Delta #phi in trackedEE for signal and bkgnds","#Delta #phi","c19","dPhi_trackedEE_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"trackedEE");

	//compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>epTrackedEndcapSignalList","epTrackedEndcapSignalList",">>epTrackedEndcapVHPtBkgndList","epTrackedEndcapVHPtBkgndList",">>epTrackedEndcapHPtBkgndList","epTrackedEndcapHPtBkgndList",">>epTrackedEndcapLPtBkgndList","epTrackedEndcapLPtBkgndList","epHltEle>>epTrackedEndcapSignalHisto(100,0.,0.25)","epHltEle>>epTrackedEndcapVHPtBkgndHisto(100,0.,0.25)","epHltEle>>epTrackedEndcapHPtBkgndHisto(100,0.,0.25)","epHltEle>>epTrackedEndcapLPtBkgndHisto(100,0.,0.25)","epTrackedEndcapSignalHisto","epTrackedEndcapVHPtBkgndHisto","epTrackedEndcapHPtBkgndHisto","epTrackedEndcapLPtBkgndHisto",0.24,0.13,0.16,"E/P in trackedEE for signal and bkgnds","E/P","c20","ep_trackedEE_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"trackedEE");

	compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>trackIsoTrackedEndcapSignalList","trackIsoTrackedEndcapSignalList",">>trackIsoTrackedEndcapVHPtBkgndList","trackIsoTrackedEndcapVHPtBkgndList",">>trackIsoTrackedEndcapHPtBkgndList","trackIsoTrackedEndcapHPtBkgndList",">>trackIsoTrackedEndcapLPtBkgndList","trackIsoTrackedEndcapLPtBkgndList","trackIsoHltEle>>trackIsoTrackedEndcapSignalHisto(100,0.,0.25)","trackIsoHltEle>>trackIsoTrackedEndcapVHPtBkgndHisto(100,0.,0.25)","trackIsoHltEle>>trackIsoTrackedEndcapHPtBkgndHisto(100,0.,0.25)","trackIsoHltEle>>trackIsoTrackedEndcapLPtBkgndHisto(100,0.,0.25)","trackIsoTrackedEndcapSignalHisto","trackIsoTrackedEndcapVHPtBkgndHisto","trackIsoTrackedEndcapHPtBkgndHisto","trackIsoTrackedEndcapLPtBkgndHisto",0.2,0.1,0.125,"relative trackIso in trackedEE for signal and bkgnds","relative trackIso","c22","rel_trackIso_trackedEE_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"trackedEE");
	
	compareMatchedSigAndBkgnd(matchedTrackedSignalChain,trackedVeryHighPtBkgndChain,trackedHighPtBkgndChain,trackedLowPtBkgndChain,">>ptTrackedEndcapSignalList","ptTrackedEndcapSignalList",">>ptTrackedEndcapVHPtBkgndList","ptTrackedEndcapVHPtBkgndList",">>ptTrackedEndcapHPtBkgndList","ptTrackedEndcapHPtBkgndList",">>ptTrackedEndcapLPtBkgndList","ptTrackedEndcapLPtBkgndList","ptHltEle>>ptTrackedEndcapSignalHisto(100,0.,35.)","ptHltEle>>ptTrackedEndcapVHPtBkgndHisto(100,0.,35.)","ptHltEle>>ptTrackedEndcapHPtBkgndHisto(100,0.,35.)","ptHltEle>>ptTrackedEndcapLPtBkgndHisto(100,0.,35.)","ptTrackedEndcapSignalHisto","ptTrackedEndcapVHPtBkgndHisto","ptTrackedEndcapHPtBkgndHisto","ptTrackedEndcapLPtBkgndHisto",27,27,27,"pt in trackedEE for signal and bkgnds","pt","c24","pt_trackedEE_matched_signal_and_bkgnds_showing_scan_range.png",true,false,true,false,"trackedEE");



	///tracklessEE
	//compareMatchedSigAndBkgnd(matchedTracklessSignalChain,tracklessVeryHighPtBkgndChain,tracklessHighPtBkgndChain,tracklessLowPtBkgndChain,">>clusterShapeTracklessEndcapSignalList","clusterShapeTracklessEndcapSignalList",">>clusterShapeTracklessEndcapVHPtBkgndList","clusterShapeTracklessEndcapVHPtBkgndList",">>clusterShapeTracklessEndcapHPtBkgndList","clusterShapeTracklessEndcapHPtBkgndList",">>clusterShapeTracklessEndcapLPtBkgndList","clusterShapeTracklessEndcapLPtBkgndList","clusterShapeHltEle>>clusterShapeTracklessEndcapSignalHisto(100,0.,0.08)","clusterShapeHltEle>>clusterShapeTracklessEndcapVHPtBkgndHisto(100,0.,0.08)","clusterShapeHltEle>>clusterShapeTracklessEndcapHPtBkgndHisto(100,0.,0.08)","clusterShapeHltEle>>clusterShapeTracklessEndcapLPtBkgndHisto(100,0.,0.08)","clusterShapeTracklessEndcapSignalHisto","clusterShapeTracklessEndcapVHPtBkgndHisto","clusterShapeTracklessEndcapHPtBkgndHisto","clusterShapeTracklessEndcapLPtBkgndHisto",0.055,0.049,0.052,"#sigma_{i#etai#eta} in tracklessEE for signal and bkgnds","#sigma_{i#etai#eta}","c9","cluster_shape_tracklessEE_matched_signal_and_bkgnds_showing_scan_range.png",false,false,false,false,"tracklessEE");

	//compareMatchedSigAndBkgnd(matchedTracklessSignalChain,tracklessVeryHighPtBkgndChain,tracklessHighPtBkgndChain,tracklessLowPtBkgndChain,">>hadEmTracklessEndcapSignalList","hadEmTracklessEndcapSignalList",">>hadEmTracklessEndcapVHPtBkgndList","hadEmTracklessEndcapVHPtBkgndList",">>hadEmTracklessEndcapHPtBkgndList","hadEmTracklessEndcapHPtBkgndList",">>hadEmTracklessEndcapLPtBkgndList","hadEmTracklessEndcapLPtBkgndList","hadEmHltEle>>hadEmTracklessEndcapSignalHisto(100,0.,0.65)","hadEmHltEle>>hadEmTracklessEndcapVHPtBkgndHisto(100,0.,0.65)","hadEmHltEle>>hadEmTracklessEndcapHPtBkgndHisto(100,0.,0.65)","hadEmHltEle>>hadEmTracklessEndcapLPtBkgndHisto(100,0.,0.65)","hadEmTracklessEndcapSignalHisto","hadEmTracklessEndcapVHPtBkgndHisto","hadEmTracklessEndcapHPtBkgndHisto","hadEmTracklessEndcapLPtBkgndHisto",0.39,0.31,0.35,"relative H/E in tracklessEE for signal and bkgnds","relative H/E","c10","rel_HoverE_tracklessEE_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"tracklessEE");

	//compareMatchedSigAndBkgnd(matchedTracklessSignalChain,tracklessVeryHighPtBkgndChain,tracklessHighPtBkgndChain,tracklessLowPtBkgndChain,">>ecalIsoTracklessEndcapSignalList","ecalIsoTracklessEndcapSignalList",">>ecalIsoTracklessEndcapVHPtBkgndList","ecalIsoTracklessEndcapVHPtBkgndList",">>ecalIsoTracklessEndcapHPtBkgndList","ecalIsoTracklessEndcapHPtBkgndList",">>ecalIsoTracklessEndcapLPtBkgndList","ecalIsoTracklessEndcapLPtBkgndList","ecalIsoHltEle>>ecalIsoTracklessEndcapSignalHisto(100,0.,0.65)","ecalIsoHltEle>>ecalIsoTracklessEndcapVHPtBkgndHisto(100,0.,0.65)","ecalIsoHltEle>>ecalIsoTracklessEndcapHPtBkgndHisto(100,0.,0.65)","ecalIsoHltEle>>ecalIsoTracklessEndcapLPtBkgndHisto(100,0.,0.65)","ecalIsoTracklessEndcapSignalHisto","ecalIsoTracklessEndcapVHPtBkgndHisto","ecalIsoTracklessEndcapHPtBkgndHisto","ecalIsoTracklessEndcapLPtBkgndHisto",0.39,0.31,0.35,"relative ecalIso in tracklessEE for signal and bkgnds","relative ecalIso","c11","rel_ecalIso_tracklessEE_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"tracklessEE");

	//compareMatchedSigAndBkgnd(matchedTracklessSignalChain,tracklessVeryHighPtBkgndChain,tracklessHighPtBkgndChain,tracklessLowPtBkgndChain,">>hcalIsoTracklessEndcapSignalList","hcalIsoTracklessEndcapSignalList",">>hcalIsoTracklessEndcapVHPtBkgndList","hcalIsoTracklessEndcapVHPtBkgndList",">>hcalIsoTracklessEndcapHPtBkgndList","hcalIsoTracklessEndcapHPtBkgndList",">>hcalIsoTracklessEndcapLPtBkgndList","hcalIsoTracklessEndcapLPtBkgndList","hcalIsoHltEle>>hcalIsoTracklessEndcapSignalHisto(100,0.,1.2)","hcalIsoHltEle>>hcalIsoTracklessEndcapVHPtBkgndHisto(100,0.,1.2)","hcalIsoHltEle>>hcalIsoTracklessEndcapHPtBkgndHisto(100,0.,1.2)","hcalIsoHltEle>>hcalIsoTracklessEndcapLPtBkgndHisto(100,0.,1.2)","hcalIsoTracklessEndcapSignalHisto","hcalIsoTracklessEndcapVHPtBkgndHisto","hcalIsoTracklessEndcapHPtBkgndHisto","hcalIsoTracklessEndcapLPtBkgndHisto",1.01,0.85,0.93,"relative hcalIso in tracklessEE for signal and bkgnds","relative hcalIso","c12","rel_hcalIso_tracklessEE_matched_signal_and_bkgnds_showing_scan_range.png",false,true,false,false,"tracklessEE");

	//compareMatchedSigAndBkgnd(matchedTracklessSignalChain,tracklessVeryHighPtBkgndChain,tracklessHighPtBkgndChain,tracklessLowPtBkgndChain,">>ptTracklessEndcapSignalList","ptTracklessEndcapSignalList",">>ptTracklessEndcapVHPtBkgndList","ptTracklessEndcapVHPtBkgndList",">>ptTracklessEndcapHPtBkgndList","ptTracklessEndcapHPtBkgndList",">>ptTracklessEndcapLPtBkgndList","ptTracklessEndcapLPtBkgndList","ptHltEle>>ptTracklessEndcapSignalHisto(100,0.,35.)","ptHltEle>>ptTracklessEndcapVHPtBkgndHisto(100,0.,35.)","ptHltEle>>ptTracklessEndcapHPtBkgndHisto(100,0.,35.)","ptHltEle>>ptTracklessEndcapLPtBkgndHisto(100,0.,35.)","ptTracklessEndcapSignalHisto","ptTracklessEndcapVHPtBkgndHisto","ptTracklessEndcapHPtBkgndHisto","ptTracklessEndcapLPtBkgndHisto",16,24,20,"Pt in tracklessEE for signal and bkgnds","pt","c13","pt_tracklessEE_matched_signal_and_bkgnds_showing_scan_range.png",true,false,true,false,"tracklessEE");
