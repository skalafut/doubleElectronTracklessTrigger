...
config.General.requestName = 'skim_QCDInclusive'
config.General.workArea = 'crab_project_skim_QCDInclusive'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '/afs/cern.ch/work/s/skalafut/public/doubleElectronHLT/hlt2017/CMSSW_9_0_2/src/doubleElectronTracklessTrigger/doubleEleTracklessAnalyzer/test/hltSkimDoubleEle_QCDInclusive.py'
config.JobType.maxMemoryMB = 2500 #should not need this option for skims

config.Data.inputDataset = '/QCD_Pt-15to3000_TuneCUETP8M1_Flat_13TeV_pythia8/PhaseIFall16DR-FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v2/GEN-SIM-RAW'
...
config.Data.outLFNDirBase = '/store/group/phys_exotica/leptonsPlusJets/WR/skims/QCDInclusive_SKv1/'
config.Data.publication = False
#config.Data.publishDataName = 'skimmed'
config.Data.outputDatasetTag = 'QCDInclusive'
