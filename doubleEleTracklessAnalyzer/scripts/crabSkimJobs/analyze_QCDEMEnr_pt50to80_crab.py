...
config.General.requestName = 'skim_QCD_emenr_pt50to80'
config.General.workArea = 'crab_project_skim_QCD_emenr_pt50to80'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '/afs/cern.ch/work/s/skalafut/public/doubleElectronHLT/hlt2017/CMSSW_9_0_2/src/doubleElectronTracklessTrigger/doubleEleTracklessAnalyzer/test/hltSkimDoubleEle_QCD_emenr_pt50to80.py'
...
config.Data.outLFNDirBase = '/store/group/phys_exotica/leptonsPlusJets/WR/skims/QCD_emenr_pt50to80_SKv1/'
config.Data.publication = False
#config.Data.publishDataName = 'skimmed'
config.Data.outputDatasetTag = 'QCD_emenr_pt50to80'
