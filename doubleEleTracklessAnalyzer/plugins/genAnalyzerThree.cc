// -*- C++ -*-
//
// Package:    doubleElectronTracklessTrigger/genAnalyzerThree
// Class:      genAnalyzerThree
// 
/**\class genAnalyzerThree genAnalyzerThree.cc doubleElectronTracklessTrigger/genAnalyzerThree/plugins/genAnalyzerThree.cc
...
class genAnalyzerThree : public edm::EDAnalyzer {
   public:
      explicit genAnalyzerThree(const edm::ParameterSet&);
      ~genAnalyzerThree();
...
genAnalyzerThree::genAnalyzerThree(const edm::ParameterSet& iConfig):
...
genAnalyzerThree::~genAnalyzerThree()
{
...
void
genAnalyzerThree::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	using namespace edm;
	
	iEvent.getByLabel(eleCollOneTag, untrackedLeptHandle);
	iEvent.getByLabel(eleCollTwoTag, trackedLeptHandle);
	iEvent.getByLabel(eleCollThreeTag, leptonsFromZHandle);

	if(!leptonsFromZHandle.isValid() || !untrackedLeptHandle.isValid() || untrackedLeptHandle->size() < 1 || !trackedLeptHandle.isValid() || trackedLeptHandle->size() < 1) return;

	//if there is a trackless electron with pt>15 (evt is skipped if untrackedLeptHandle->size() is less than 1)
	//and a tracked electron with pt>27 (evt is skipped if trackedLeptHandle->size() is less than 1) in this event,
	//then both of these objects will be in the collection tied to leptonsFromZHandle
	edm::OwnVector<reco::Candidate>::const_iterator leading = leptonsFromZHandle->end(), subleading = leptonsFromZHandle->end();
...
/*
void 
genAnalyzerThree::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
genAnalyzerThree::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
genAnalyzerThree::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
genAnalyzerThree::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
genAnalyzerThree::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
/*
void genAnalyzerThree::InitNewTree(void){
...
void genAnalyzerThree::TreeSetSingleElectronVar(const pat::Electron& electron1, int index){
...
void genAnalyzerThree::TreeSetSingleElectronVar(const reco::SuperCluster& electron1, int index){
...
void genAnalyzerThree::TreeSetDiElectronVar(const pat::Electron& electron1, const reco::SuperCluster& electron2){
...
DEFINE_FWK_MODULE(genAnalyzerThree);
