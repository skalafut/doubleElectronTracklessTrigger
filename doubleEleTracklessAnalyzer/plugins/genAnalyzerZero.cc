// -*- C++ -*-
//
// Package:    doubleElectronTracklessTrigger/genAnalyzerZero
// Class:      genAnalyzerZero
// 
/**\class genAnalyzerZero genAnalyzerZero.cc doubleElectronTracklessTrigger/genAnalyzerZero/plugins/genAnalyzerZero.cc
...
class genAnalyzerZero : public edm::EDAnalyzer {
   public:
      explicit genAnalyzerZero(const edm::ParameterSet&);
      ~genAnalyzerZero();
...
genAnalyzerZero::genAnalyzerZero(const edm::ParameterSet& iConfig):
...
genAnalyzerZero::~genAnalyzerZero()
{
...
void
genAnalyzerZero::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	using namespace edm;

	iEvent.getByLabel(eleCollOneTag, genPart);

	std::vector<reco::GenParticle>::const_iterator leading = genPart->end(), subleading = genPart->end();
	...
	for(std::vector<reco::GenParticle>::const_iterator genIt = genPart->begin(); genIt != genPart->end(); genIt++){
		if(std::fabs(genIt->pdgId()) == 11 && std::fabs(genIt->mother(0)->pdgId()) == 23){
			if(leading==genPart->end()) leading=genIt;
			else{
				if(genIt->pt() > leading->pt()){
					subleading = leading;
					leading = genIt;
				}
				else if(subleading==genPart->end() || genIt->pt() > subleading->pt()) subleading = genIt;
			}
		}
...
/*
void 
genAnalyzerZero::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
genAnalyzerZero::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
genAnalyzerZero::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
genAnalyzerZero::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
genAnalyzerZero::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
/*
void genAnalyzerZero::InitNewTree(void){
...
void genAnalyzerZero::TreeSetSingleElectronVar(const pat::Electron& electron1, int index){
...
void genAnalyzerZero::TreeSetSingleElectronVar(const reco::SuperCluster& electron1, int index){
...
void genAnalyzerZero::TreeSetDiElectronVar(const pat::Electron& electron1, const reco::SuperCluster& electron2){
...
DEFINE_FWK_MODULE(genAnalyzerZero);
